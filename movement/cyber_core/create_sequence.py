...
from cyber_core.dark_kinematics_dashed import create_new_ms, move_body_straight, move_2_legs, move_2_legs_x3
...
def calculate_sequence(movement, ground_z = -14):    
    ...
    if movement == 'forward':
        ...
        #ms.body_movement(-3, 0, 0)
        #move_2_legs(ms, 12, sync_body=True)
        #move_2_legs_x3(ms, 12)
